...
def draw_cannon(x, y):
    ...
    y1 = 550
    r = 50
    muzzle = canv.create_oval(x1-r, y1-r, x1+r, y1+r,fill='black')
    gun_barrel = canv.create_line(x, y, x - 70, y + 70 ,width=20,fill='black')
...
class Shell:
    ...
    def __init__(self, x, y, Vx, Vy):
        ...
        r = 5
        draw_shell = canv.create_oval(x-r, y-r, x+r, y+r, fill='red')
